...
import {useWallet, Wallet, WalletName, WalletReadyState} from "@manahippo/aptos-wallet-adapter";
                ...
                <div className="wallet-adapter-modal-container">
                    <div className="wallet-adapter-modal-wrapper">
                        ...
                        {installedWallets.length ? (
                            <>
                                <h1 className="wallet-adapter-modal-title">Connect a wallet on Aptos to continue</h1>
                            ...
                            <>
                                <h1 className="wallet-adapter-modal-title">
                                    need a wallet on Aptos to continue
                                </h1>
